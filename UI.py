...
max_generation_flips_scale = tk.Scale(left_frame, from_=10, to=500, variable=max_generation_var, orient='horizontal')
max_generation_flips_scale.grid(row=9, column=1, padx=5, pady=5)
